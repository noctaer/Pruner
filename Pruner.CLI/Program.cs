...
{
    Console.WriteLine($"Pruner {Version}");
    return 0;
}
...
if (inputs.Count == 0)
{
    ...
    Console.Error.WriteLine("Run 'Pruner --help' for usage.");
    return 1;
}
...
{
    Console.WriteLine("Pruner — removes all comments from source code files");
    Console.WriteLine();
    Console.WriteLine("Usage:");
    Console.WriteLine("  Pruner <file> [file2 ...] [options]");
    Console.WriteLine("  Pruner <directory> [options]");
    Console.WriteLine("  Pruner *.cs [options]");
    Console.WriteLine();
